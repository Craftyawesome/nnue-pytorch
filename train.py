...
def main():
  ...
  parser.add_argument("--max_epochs", default=800, type=int, dest="max_epochs", help="Number of epochs to train for.")
  parser.add_argument("--gpus", default="0,", type=str, dest="gpus", help="A list of GPU IDs to use for training. Note that a single run still uses a single GPU.")
